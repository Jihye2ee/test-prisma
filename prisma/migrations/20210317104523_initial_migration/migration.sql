...
-- CreateTable
CREATE TABLE `lung_registration` (
    `comparison_study_instance_uid` VARCHAR(191) NOT NULL,
    `comparison_series_instance_uid` VARCHAR(191) NOT NULL,
    `comparison_homography_matrix` VARCHAR(191) NOT NULL,
    `creation_timestamp` INT NOT NULL DEFAULT 0,
    `lung_registration_request_uuid` VARCHAR(191) NOT NULL,
    `homography_matrix` VARCHAR(191) NOT NULL,
    `seq` INT NOT NULL AUTO_INCREMENT,
